  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="space-y-1">
        <h1 className="text-3xl tracking-tight">Xin chào, Admin</h1>
        <p className="text-muted-foreground text-sm">
          Theo dõi lưu lượng truy cập, tương tác và hiệu suất chuyển đổi trong một góc nhìn.
        </p>
      </div>
      ...
      <Tabs defaultValue="overview" className="flex flex-col gap-4">
        ...
        <TabsContent value="audience">
          <div className="flex h-64 items-center justify-center rounded-xl border border-border border-dashed text-muted-foreground">
            Giao diện đối tượng sẽ sớm ra mắt.
          </div>
        </TabsContent>

        <TabsContent value="acquisition">
          <div className="flex h-64 items-center justify-center rounded-xl border border-border border-dashed text-muted-foreground">
            Giao diện nguồn truy cập sẽ sớm ra mắt.
          </div>
        </TabsContent>

        <TabsContent value="engagement">
          <div className="flex h-64 items-center justify-center rounded-xl border border-border border-dashed text-muted-foreground">
            Giao diện tương tác sẽ sớm ra mắt.
          </div>
        </TabsContent>

        <TabsContent value="conversions">
          <div className="flex h-64 items-center justify-center rounded-xl border border-border border-dashed text-muted-foreground">
            Giao diện chuyển đổi sẽ sớm ra mắt.
          </div>
        </TabsContent>
      </Tabs>
    </div>
