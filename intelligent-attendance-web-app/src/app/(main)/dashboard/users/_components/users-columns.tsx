      ...
      <div className="text-right">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              aria-label={`Mo thao tac cho ${row.original.name}`}
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem>Quản lý nhóm</DropdownMenuItem>
            <DropdownMenuItem>Gửi lại lời mời</DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem variant="destructive">Vô hiệu hóa</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
    ),
