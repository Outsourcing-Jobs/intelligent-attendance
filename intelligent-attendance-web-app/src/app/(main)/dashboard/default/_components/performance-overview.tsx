...
export function PerformanceOverview() {
  return (
    <Card className="@container/card">
      <CardHeader>
        <CardTitle className="leading-none">Hoạt động khách hàng</CardTitle>
        <CardDescription>
          <span className="@[540px]/card:block hidden">Hoạt động của khách hàng trong 3 tháng qua</span>
