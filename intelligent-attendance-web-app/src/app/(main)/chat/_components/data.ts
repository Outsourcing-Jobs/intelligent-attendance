...
export const navItems: NavItem[] = [
  { id: "inbox", title: "Hộp thư", label: "24", icon: Inbox, isActive: true },
  { id: "mentions", title: "Nhắc đến", label: "3", icon: Mail, isActive: false },
  { id: "snoozed", title: "Tạm ẩn", icon: Clock3, isActive: false },
  { id: "sent", title: "Đã gửi", icon: Send, isActive: false },
  { id: "all", title: "Tất cả trò chuyện", icon: MessageCircle, isActive: false },
  { id: "unassigned", title: "Chưa phân công", label: "7", icon: User, isActive: false },
];

export const channelItems: NavItem[] = [
  { id: "email", title: "Email", label: "18", icon: Mail, isActive: false },
  { id: "chat", title: "Trò chuyện", label: "5", icon: MessageCircle, isActive: false },
  ...
  { id: "phone", title: "Điện thoại", label: "0", icon: Phone, isActive: false },
];

export const viewItems: NavItem[] = [
  { id: "vip", title: "Khách hàng VIP", label: "8", icon: Star, isActive: false },
  { id: "orders", title: "Đơn hàng & Đổi trả", label: "6", icon: Inbox, isActive: false },
  { id: "feedback", title: "Góp ý sản phẩm", label: "2", icon: MessageCircle, isActive: false },
];
