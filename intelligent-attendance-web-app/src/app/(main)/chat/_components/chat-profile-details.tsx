      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-3 text-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-muted-foreground text-sm">Trang web</span>
        ...
        <div className="flex flex-col gap-3 text-sm">
          <div className="flex items-center gap-2">
            ...
            <span className="text-muted-foreground text-sm">Công ty</span>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-muted-foreground text-sm">Đánh giá từ</span>
            <span className="ml-auto truncate text-sm">{contact.qualifiedAt}</span>
          </div>
          <div className="flex items-center gap-2">
            <Monitor className="size-4 shrink-0 text-muted-foreground" />
            <span className="text-muted-foreground text-sm">Múi giờ</span>
        ...
        <div className="flex flex-col gap-3 text-sm">
          ...
          <div className="flex items-start gap-2">
            ...
            <span className="text-muted-foreground text-sm">Thẻ</span>
